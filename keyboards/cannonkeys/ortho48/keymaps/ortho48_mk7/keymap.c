...
[_LOWER] = LAYOUT_ortho_4x12(
    ...
    KC_DEL,  NO_SLSH,   NO_LPRN,   NO_RPRN,  NO_APOS,   NO_GRV,   _______,   NO_UNDS,    NO_LCBR_MAC, NO_RCBR_MAC, NO_PLUS, NO_PIPE,
    _______, NO_BSLS,   NO_LCBR, NO_RCBR,   NO_QUO2,  _______,  _______,  S(KC_NUHS), NO_LBRC, NO_RBRC, S(KC_NUBS), _______,
