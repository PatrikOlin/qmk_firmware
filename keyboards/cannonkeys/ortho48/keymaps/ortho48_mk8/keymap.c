...
[_LOWER] = LAYOUT_ortho_4x12(
    ...
    KC_TRNS, NO_BSLS,   NO_LCBR, NO_RCBR,   NO_QUO2,  _______,  _______,  NO_UNDS, NO_LBRC, NO_RBRC, S(KC_NUBS), _______,
...
[_RAISE] = LAYOUT_ortho_4x12(
    ...
    KC_TRNS, _______,   _______,   _______,   _______,  _______,  _______,  KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, _______,
