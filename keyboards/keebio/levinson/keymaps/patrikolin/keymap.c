...
[_QWERTY] = LAYOUT_ortho_4x12( \
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  SE_QUES, KC_ENT , \
...
[_LOWER] = LAYOUT_ortho_4x12( \
    ...
    _______, SE_BSLS_MAC,   SE_LCBR,   SE_RCBR,   SE_QUO2,  _______,  _______,  SE_UNDS, SE_LBRC, SE_RBRC, SE_EQL,  S(KC_NUBS),
    DYN_MACRO_PLAY1,   DYN_MACRO_PLAY2, SE_LBRC, SE_RBRC, KC_TRNS, _______, _______, KC_TRNS,    KC_MNXT,    KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_RAISE] = LAYOUT_ortho_4x12( \
  ...
  DYN_REC_START1, DYN_REC_START2, DYN_REC_STOP, _______, KC_TRNS, _______, _______, KC_TRNS, KC_0, _______, _______, _______ \
),

[_DYN] = LAYOUT_ortho_4x12( \
  KC_ESC,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, \
  KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  SE_QUES, KC_ENT , \
  KC_LCTL,  KC_LGUI, KC_LALT, KC_BSPC, TT(_LOWER),   KC_SPC,  KC_LEAD,  TT(_RAISE),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
