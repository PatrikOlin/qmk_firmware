 ...
 * `-----------------------------------------------------------------------------------'
 */
[_SANE] = LAYOUT_preonic_grid( \
  ENCADJ,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL, \
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_ADJUSTMAC] = LAYOUT_preonic_grid( \
  ...
  float ss_1_u[][2]            = SONG(SCROLL_SPEED_1_U);
  float ss_2_d[][2]            = SONG(SCROLL_SPEED_2_D);
  float ss_2_u[][2]            = SONG(SCROLL_SPEED_2_U);
  float ss_3_d[][2]            = SONG(SCROLL_SPEED_3_D);
  float ss_3_u[][2]            = SONG(SCROLL_SPEED_3_U);
  float ss_4_d[][2]            = SONG(SCROLL_SPEED_4_D);
  float ss_4_u[][2]            = SONG(SCROLL_SPEED_4_U);
  float ss_5_d[][2]            = SONG(SCROLL_SPEED_5_D);
